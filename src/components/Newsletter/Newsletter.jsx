...
const Newsletter = () => {
	return (
		<div>
			<div className="flex flex-col w-full mx-auto overflow-hidden shadow-lg dark:bg-coal md:flex-row md:h-24">
				<div className="md:flex md:items-center md:justify-center md:w-1/2 md:bg-coal md:dark:coal">
				...
				<div className="flex items-center justify-center pb-6 md:py-0 md:w-1/2">
					<form>
						<div className="flex flex-col p-1.5 overflow-hidden border rounded-lg dark:border-gray-600 lg:flex-row dark:focus-within:border-blue-300 focus-within:ring focus-within:ring-opacity-40 focus-within:border-blue-400 focus-within:ring-blue-300">
							<input
								className="px-6 py-2 text-gray-700 placeholder-gray-500 bg-white outline-none dark:bg-coal dark:placeholder-gray-400 focus:placeholder-transparent dark:focus:placeholder-transparent"
								type="text"
								name="email"
