...
import photo from '../../assets/camera-5385295-4499552.png'

const Content = () => {
	return (
		<section className=" bg-coal dark:text-gray-100 py-16 md:px-20 lg:px-20">
			<h2 className="container text-center lg:px-20 mx-auto text-[#E8AD8B] font-bold pl-4 text-sm uppercase">
				Our Services
			</h2>
			<h2 className="container pb-32 text-center py-4 lg:px-20 mx-auto text-gray-300 font-bold pl-4 text-lg lg:text-3xl uppercase">
				Our Special Features
			</h2>

			<div className="flex items-center justify-center px-5">
			    <div className="grid grid-cols-1 gap-10 md:gap-12 lg:gap-14 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
					<div className="relative cursor-pointer group rounded-2xl w-full min-h-80 sm:w-72" data-aos="fade-up" data-aos-anchor-placement="top-bottom" >
					  	<div className="text-white flex items-center absolute rounded-full py-2 px-2 sm:py-4 sm:px-4 shadow-xl bg-pink-500 left-[10rem] md:left-[7rem] lg:[7rem] -top-3 sm:-top-6">
							<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
							 width="30px" height="30px" viewBox="0 0 1280.000000 916.000000"
					  	...
					  	<div className="rounded-2xl bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 p-1 shadow-xl">
					    	<div className="block min-h-[140px] sm:min-h-[240px] rounded-xl bg-white group-hover:bg-coal duration-300 p-4 sm:p-6 lg:p-8" href="">
					      		<div className="mt-4 sm:mt-8">
					        		<h3 className="text-lg text-center font-bold text-gray-900 sm:text-xl group-hover:text-gray-300 duration-300">
					        		  Wedding Photography
					        		</h3>
					        		<p className="mt-2 font-semibold text-gray-500 group-hover:text-gray-300 duration-300">
					        		</p>
					      		</div>
					    	</div>
					  	</div>
					...
					<div className="relative cursor-pointer group rounded-2xl w-full min-h-80 sm:w-72" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="550">
						<div className="text-white flex items-center absolute rounded-full py-2 px-2 sm:py-4 sm:px-4 shadow-xl bg-pink-500 left-[10rem] md:left-[7rem] lg:[7rem] -top-3 sm:-top-6">
							<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
							 width="30px" height="30px" viewBox="0 0 1280.000000 916.000000"
							 preserveAspectRatio="xMidYMid meet">
					...
					<div className="relative cursor-pointer group rounded-2xl w-full min-h-80 sm:w-72" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="700">
						<div className="text-white flex items-center absolute rounded-full py-2 px-2 sm:py-4 sm:px-4 shadow-xl bg-pink-500 left-[10rem] md:left-[7rem] lg:[7rem] -top-3 sm:-top-6">
							<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
							 width="30px" height="30px" viewBox="0 0 1280.000000 916.000000"
							 preserveAspectRatio="xMidYMid meet">
					...
					<div className="relative cursor-pointer group rounded-2xl w-full sm:w-72" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="850">
						<div className="text-white flex items-center absolute rounded-full py-2 px-2 sm:py-4 sm:px-4 shadow-xl bg-pink-500 left-[10rem] md:left-[7rem] lg:[7rem] -top-3 sm:-top-6">
							<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
							 width="30px" height="30px" viewBox="0 0 1280.000000 916.000000"
							 preserveAspectRatio="xMidYMid meet">
